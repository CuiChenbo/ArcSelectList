...
import com.ccb.arcselect.view.HMatrixTranslateLayout;
 ...
 */
public class BottomArcActivity extends AppCompatActivity {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            vh.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    scrollToCenter(fp);
                    Toast.makeText(BottomArcActivity.this, "点击" + mDatas.get(fp), Toast.LENGTH_SHORT).show();
                }
            });
        }
